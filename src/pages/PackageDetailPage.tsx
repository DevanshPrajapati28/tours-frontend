        ...
        <div className="pkg-body-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 2fr) minmax(300px, 1fr)', gap: '2.5rem', alignItems: 'start' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(195px, 1fr))', gap: '.65rem' }}>
                {pkg.highlights.map((h, i) => (
                  <div key={i}
                    ...
                    onMouseEnter={e => { const el = e.currentTarget as HTMLDivElement; el.style.borderColor = 'var(--primary)'; el.style.transform = 'translateY(-2px)'; el.style.boxShadow = '0 6px 20px -6px rgba(15,76,129,.18)'; }}
          ...
          <aside>
            <div style={{ position: 'sticky', top: 88, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              {/* Price card */}
              <div style={{ borderRadius: 20, overflow: 'hidden', border: '1px solid var(--border)', boxShadow: '0 12px 40px -10px rgba(15,76,129,.22)' }}>
