...
const values = [
  { icon: Heart, title: 'Customer First', desc: 'Your joy is our ultimate reward. Every decision starts and ends with your satisfaction.', color: '#ec4899', bg: 'rgba(236, 72, 153, 0.1)' },
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
            ...
            <div style={{ position: 'relative', height: '550px', width: '100%' }}>
              ...
              {/* Badge */}
              <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', background: 'var(--accent)', color: '#fff', width: '130px', height: '130px', borderRadius: '50%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', zIndex: 4, boxShadow: '0 10px 30px rgba(255, 107, 53, 0.4)', border: '6px solid #f0f4f8' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem' }}>
            {stats.map(({ icon: Icon, value, label }) => (
              ...
              onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.background = 'rgba(255,255,255,0.03)' }}>
                <div style={{ width: '64px', height: '64px', margin: '0 auto 1.25rem', background: 'linear-gradient(135deg, rgba(255,107,53,0.2) 0%, rgba(255,107,53,0) 100%)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,107,53,0.3)' }}>
