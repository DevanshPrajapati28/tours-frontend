...
export const services: Service[] = [
  { title: 'Domestic Holiday Packages', description: 'Discover the beauty of incredible India with curated domestic tours.', icon: 'MapPin' },
  { title: 'International Holiday Packages', description: 'Explore the world with handcrafted international getaways.', icon: 'Globe' },
  { title: 'Customized Tour Packages', description: 'Tailor-made itineraries designed around your dreams and budget.', icon: 'Sparkles' },
  { title: 'Hotel Reservations Worldwide', description: 'Best rates on hotels and resorts across the globe.', icon: 'Hotel' },
  { title: 'Flight Ticket Bookings', description: 'Cheapest fares on domestic and international flights.', icon: 'Plane' },
  { title: 'Train Ticket Bookings', description: 'Hassle-free rail bookings and scenic train journeys.', icon: 'TrainFront' },
  { title: 'Luxury Cruise Bookings', description: 'Sail in style with premium cruise holiday packages.', icon: 'Ship' },
  { title: 'Visa Assistance', description: 'End-to-end visa documentation and processing support.', icon: 'FileCheck' },
  { title: 'Passport Assistance', description: 'Quick and reliable passport application assistance.', icon: 'BookUser' },
  { title: 'Honeymoon Packages', description: 'Romantic escapes designed for unforgettable beginnings.', icon: 'Heart' },
  { title: 'Family Vacations', description: 'Fun-filled trips crafted for the whole family.', icon: 'Users' },
  { title: 'Corporate Trips', description: 'Seamless MICE and corporate travel management.', icon: 'Briefcase' },
]
