...
export default function AdminLogin() {
  ...
  return (
    <div style={{
      ...
      background: 'linear-gradient(135deg, #0f4c81 0%, #1a6ab5 50%, #0f4c81 100%)',
      padding: '1rem',
    }}>
      {/* Background pattern */}
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{
            ...
            borderRadius: 20, background: 'rgba(255,107,53,.9)', marginBottom: '1rem',
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <button type="submit" disabled={loading} style={{
            ...
            background: loading ? 'rgba(255,107,53,.5)' : 'var(--accent)',
            color: '#fff', fontSize: '1rem', fontWeight: 700,
            cursor: loading ? 'not-allowed' : 'pointer', transition: 'all .2s',
            boxShadow: '0 4px 16px rgba(255,107,53,.4)',
