        ...
        {['all', ...STATUS_OPTIONS].map(s => {
          ...
          return (
            <button key={s} onClick={() => setFilterStatus(s)} style={{
              ...
              background: filterStatus === s ? '#0f4c81' : '#fff',
          ...
          <div style={{ borderRadius: 16, background: '#fff', border: '1px solid #e2e8f0', padding: '1.25rem', boxShadow: '0 1px 4px rgba(0,0,0,.06)', position: 'sticky', top: 72 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '.875rem', fontSize: '.875rem' }}>
              ...
              <div style={{ display: 'flex', gap: '.5rem', paddingTop: '.5rem' }}>
                <a href={`mailto:${selected.email}?subject=Re: ${selected.subject}`} style={{ flex: 1, padding: '.625rem', borderRadius: 8, textAlign: 'center', background: '#0f4c81', color: '#fff', textDecoration: 'none', fontSize: '.875rem', fontWeight: 600 }}>
                  Reply by Email
                </a>
                <a href={`tel:${selected.phone}`} style={{ flex: 1, padding: '.625rem', borderRadius: 8, textAlign: 'center', background: '#f0f7ff', color: '#0f4c81', textDecoration: 'none', fontSize: '.875rem', fontWeight: 600, border: '1px solid #bfdbfe' }}>
                  Call
                </a>
              </div>
            </div>
