  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <button onClick={() => setIsAddOpen(true)} style={{ display: 'flex', alignItems: 'center', gap: '.5rem', background: 'linear-gradient(135deg, #ff6b35 0%, #e85a28 100%)', color: '#fff', padding: '.75rem 1.5rem', borderRadius: 8, fontWeight: 600, border: 'none', cursor: 'pointer', boxShadow: '0 4px 12px rgba(255, 107, 53, 0.3)' }}>
