              ...
              <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div>
                  <span style={{ ...labelStyle, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    Itinerary
                    <button type="button" onClick={() => update('itinerary', [...(form.itinerary || []), { day: (form.itinerary?.length || 0) + 1, title: '', description: '' }])} style={{ color: '#0f4c81', background: 'none', border: 'none', fontSize: '.75rem', cursor: 'pointer', fontWeight: 600 }}>+ Add Day</button>
                  </span>
                ...
                <div>
                  <span style={{ ...labelStyle, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <button type="button" onClick={() => update('faqs', [...(form.faqs || []), { q: '', a: '' }])} style={{ color: '#0f4c81', background: 'none', border: 'none', fontSize: '.75rem', cursor: 'pointer', fontWeight: 600 }}>+ Add FAQ</button>
                  </span>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '.5rem', marginTop: '.5rem' }}>
                    {form.faqs?.map((faq, i) => (
                      <div key={i} style={{ border: '1px solid #e2e8f0', padding: '.75rem', borderRadius: 8, background: '#f8fafc' }}>
