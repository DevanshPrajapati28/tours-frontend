            ...
            <div key={dest.slug} style={{ borderRadius: 14, background: '#fff', border: '1px solid #e2e8f0', overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,.06)' }}>
              ...
              <div style={{ padding: '1rem' }}>
                ...
                <div style={{ marginTop: '.75rem', display: 'flex', gap: '.5rem', justifyContent: 'flex-end' }}>
                  <button onClick={() => openEdit(dest)} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 32, height: 32, borderRadius: 8, border: '1px solid #bfdbfe', background: '#f0f7ff', cursor: 'pointer', color: '#0f4c81', transition: 'all .15s' }}>
                    <Pencil size={14} />
                  </button>
